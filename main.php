...
<body>
    ...
    <div class="mypage_contents">
        ...
        <?php
        if (isset($shop['s'])) {
            echo "<a href='product.php'><div class='mypage_contents_btn'>
...
?>
        ...
        if (isset($shop['s'])) {
            ...
            if ($count['cnt'] > 0) {
                $exist = '1';
                if(isset($exist)){
                    echo "<a href='confir_list2.php'><div class='mypage_contents_btn'>
        ...
        <a href="board.php">
        <div class="mypage_contents_btn">
            <div class="mypage_content_text"><p>クーポン情報</p></div>
            <div class="mypage_icon"><img src="./image/arrow.png" alt=""></div>
        </div>
        </a>
    </div>
